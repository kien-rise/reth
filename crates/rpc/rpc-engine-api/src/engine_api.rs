    ...
    ChainSpec: EthereumHardforks + Send + Sync + 'static,
{
    ...
    async fn new_payload_v1(&self, payload: ExecutionPayloadV1) -> RpcResult<PayloadStatus> {
        panic!("rpc::engine | Serving engine_newPayloadV1");
        let payload =
    ...
    async fn new_payload_v2(&self, payload: ExecutionPayloadInputV2) -> RpcResult<PayloadStatus> {
        panic!("rpc::engine | Serving engine_newPayloadV2");
    ...
    async fn new_payload_v3(
        ...
        panic!("rpc::engine | Serving engine_newPayloadV3");
        let payload = ExecutionData {
    ...
    async fn new_payload_v4(
        ...
        panic!("rpc::engine | Serving engine_newPayloadV4");
        let payload = ExecutionData {
            payload: payload.into(),
    ...
    async fn fork_choice_updated_v1(
        ...
        panic!("rpc::engine | Serving engine_forkchoiceUpdatedV1");
    ...
    async fn fork_choice_updated_v2(
        ...
        panic!("rpc::engine | Serving engine_forkchoiceUpdatedV2");
    ...
    async fn fork_choice_updated_v3(
        ...
        panic!("rpc::engine | Serving engine_forkchoiceUpdatedV3");
    ...
    async fn get_payload_v1(
        ...
        panic!("rpc::engine | Serving engine_getPayloadV1");
    ...
    async fn get_payload_v2(
        ...
        panic!("rpc::engine | Serving engine_getPayloadV2");
    ...
    async fn get_payload_v3(
        ...
        panic!("rpc::engine | Serving engine_getPayloadV3");
    ...
    async fn get_payload_v4(
        ...
        panic!("rpc::engine | Serving engine_getPayloadV4");
    ...
    async fn get_payload_bodies_by_hash_v1(
        ...
        panic!("rpc::engine | Serving engine_getPayloadBodiesByHashV1");
    ...
    async fn get_payload_bodies_by_range_v1(
        ...
        panic!("rpc::engine | Serving engine_getPayloadBodiesByRangeV1");
    ...
    async fn exchange_transition_configuration(
        ...
        panic!("rpc::engine | Serving engine_exchangeTransitionConfigurationV1");
    ...
    async fn get_client_version_v1(
        ...
        panic!("rpc::engine | Serving engine_getClientVersionV1");
    ...
    async fn get_blobs_v1(
        ...
        panic!("rpc::engine | Serving engine_getBlobsV1");
