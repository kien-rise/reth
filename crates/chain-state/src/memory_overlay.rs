...
impl<N: NodePrimitives> MemoryOverlayStateProvider<N> {
    #[doc = r" Create new memory overlay state provider."]
    #[doc = r""]
    #[doc = r" ## Arguments"]
    #[doc = r""]
    #[doc = r" - `in_memory` - the collection of executed ancestor blocks in reverse."]
    #[doc = r" - `historical` - a historical state provider for the latest ancestor block stored in the"]
    #[doc = r"   database."]
    ...
    #[doc = r" Turn this state provider into a state provider"]
    pub fn boxed(self) -> Box<dyn StateProvider> {
        Box::new(self)
    }
    #[doc = r" Return lazy-loaded trie state aggregated from in-memory blocks."]
...
impl<N: NodePrimitives> BlockHashReader for MemoryOverlayStateProvider<N> {
...
impl<N: NodePrimitives> AccountReader for MemoryOverlayStateProvider<N> {
...
impl<N: NodePrimitives> StorageRootProvider for MemoryOverlayStateProvider<N> {
...
impl<N: NodePrimitives> StateProofProvider for MemoryOverlayStateProvider<N> {
    fn proof(
        &self,
        mut input: TrieInput,
        address: Address,
...
impl<N: NodePrimitives> HashedPostStateProvider for MemoryOverlayStateProvider<N> {
    fn hashed_post_state(&self, bundle_state: &BundleState) -> HashedPostState {
        self.historical.hashed_post_state(bundle_state)
    }
}
impl<N: NodePrimitives> StateProvider for MemoryOverlayStateProvider<N> {
    fn storage(
        &self,
        address: Address,
